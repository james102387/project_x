...
LEGAL_BENCHMARK_CASES: list[tuple[str, str, list[str], bool]] = [
    ...
    # ── B4: Obscure long-tail cases (LLM unlikely to know from training) ─
    (
    ...
    (
        "When was Coventry Health Care of Mo., Inc. v. Nevils decided?",
        "2017-04-18",
        ["2017"],
        False,
    ),
    (
        "Who wrote the opinion in Coventry Health Care of Mo., Inc. v. Nevils?",
        "Ginsburg",
        ["ginsburg"],
        False,
    ),
    (
        "What court decided Flanders v. Seelye?",
        "Supreme Court of the United States",
        ["supreme court"],
        False,
    ),
    (
        "When was Flanders v. Seelye decided?",
        "1882-05-18",
        ["1882"],
        False,
    ),
    (
        "Who wrote the opinion in Flanders v. Seelye?",
        "Blatchford",
        ["blatchford"],
        False,
    ),
    (
        "What court decided Gray v. Coan?",
        "Supreme Court of the United States",
        ["supreme court"],
        False,
    ),
    (
        "When was Gray v. Coan decided?",
        "1871-12-18",
        ["1871"],
        False,
    ),
    (
        "Who wrote the opinion in Gray v. Coan?",
        "Chase",
        ["chase"],
        False,
    ),
    (
        "What court decided Richards v. Mackall?",
        "Supreme Court of the United States",
        ["supreme court"],
        False,
    ),
    (
        "When was Richards v. Mackall decided?",
        "1884-10-01",
        ["1884"],
        False,
    ),
    (
        "Who wrote the opinion in Richards v. Mackall?",
        "Waite",
        ["waite"],
        False,
    ),
    (
        "What court decided Collector v. Doswell & Co.?",
        "Supreme Court of the United States",
        ["supreme court"],
        False,
    ),
    (
        "When was Collector v. Doswell & Co. decided?",
        "1873-03-31",
        ["1873"],
        False,
    ),
    (
        "What court decided Sturgis v. Clough?",
        "Supreme Court of the United States",
        ["supreme court"],
        False,
    ),
    (
        "When was Sturgis v. Clough decided?",
        "1863-12-15",
        ["1863"],
        False,
    ),
    (
        "What court decided United States v. Ramsay?",
        "Supreme Court of the United States",
        ["supreme court"],
        False,
    ),
    (
        "When was United States v. Ramsay decided?",
        "1887-01-17",
        ["1887"],
        False,
    ),
    (
        "Who wrote the opinion in United States v. Ramsay?",
        "Waite",
        ["waite"],
        False,
    ),
    (
        "What court decided Union Insurance v. Hoge?",
        "Supreme Court of the United States",
        ["supreme court"],
        False,
    ),
    (
        "When was Union Insurance v. Hoge decided?",
        "1857-05-15",
        ["1857"],
        False,
    ),
    (
        "Who wrote the opinion in Union Insurance v. Hoge?",
        "Nelson",
        ["nelson"],
        False,
    ),
    (
        "What court decided Zubik v. Burwell?",
        "Supreme Court of the United States",
        ["supreme court"],
        False,
    ),
    (
        "When was Zubik v. Burwell decided?",
        "2015-04-15",
        ["2015"],
        False,
    ),
    (
        "What court decided Lasigi v. The Collector?",
        "Supreme Court of the United States",
        ["supreme court"],
        False,
    ),
    (
        "When was Lasigi v. The Collector decided?",
        "1863-12-15",
        ["1863"],
        False,
    ),
    (
        "What court decided Pennsylvania Railroad v. St. Louis, Alton & Terre Haute Railroad?",
        "Supreme Court of the United States",
        ["supreme court"],
        False,
    ),
    (
        "When was Fentress Coal & Coke Co. v. Elmore decided?",
        "1919-04-28",
        ["1919"],
        False,
    ),
    (
        "What court decided Armstrong v. Armstrong, General Motors Corp.?",
        "Supreme Court of the United States",
        ["supreme court"],
        False,
    ),
    (
        "When was Armstrong v. Armstrong, General Motors Corp. decided?",
        "1956-04-09",
        ["1956"],
        False,
    ),
    (
        "Who were the judges in Armstrong v. Armstrong, General Motors Corp.?",
        "Black, Clark, Douglas, Frankfurter, Minton, Warren",
        ["black", "warren"],
        False,
    ),
